...
A user can unlock Lock Smart by logging into our web page. They must log into the web page with their Lock Smart account. If their account has been successfully logged into, a One-Time Pin (OTP) will be sent to their email. The user must then enter the OTP to the field provided on the Lock Smart Web App. If the generated OTP matches the user-entered OTP, Lock Smart will unlock. 
...
The Webserver and Database were set up through AWS Lambda and AWS RDS. An overview of the 2 services can be seen below.

![config](/Img/RDS/config.png)
![config2](/Img/RDS/config2.png)
![SQL Port](/Img/RDS/addingMySQLPort.png)
![SQL Config](/Img/RDS/SQLConfig.png)
![SQL Config 2](/Img/RDS/SQLConfig2.png)
![SQL Config 3](/Img/RDS/SQLConfig3.png)
![SQL Config 4](/Img/RDS/SQLConfig4.png)
![SQL Config 5](/Img/RDS/SQLConfig5.png)
![SQL Config 6](/Img/RDS/SQLConfig6.png)
![SQL Config 7](/Img/RDS/SQLConfig7.png)
![SQL Config 8](/Img/RDS/SQLConfig8.png)
...
- Physical Access Restriction Concept:
![Screw](Img/Screw.png)
- Micro usb port blocker:
![port blocker](Img/Microusb.jpeg)
